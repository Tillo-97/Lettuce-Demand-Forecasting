...
Next we will carry out a seasonal decomposition of the tie=me series to determine wether the trend and seasonality factors are significant in our data.
```{r}
